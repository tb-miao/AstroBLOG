...
<body>
    ...
    <div class="jump-container">
        ...
        <div class="jump-info">
            <div class="info-line">
                亲爱的旅行者，欢迎乘坐 <span class="highlight">AUNyaの小窝</span> 航班
            </div>
            <div class="info-line">
                目的地: <span class="highlight" id="target-site" onclick="jumpNow()">AUNyaの小窝</span>
            </div>
            <div class="info-line">
                坐标: <span class="highlight" id="target-coords">X-9511.Y-7343.Z-9588</span>
            </div>
        </div>
    ...
    <script>
        ...
        const randomSites = [
            {
                ...
                name: "AUNyaの小窝",
                coords: "X-9511.Y-7343.Z-9588"
            },
            {
                url: "https://github.com",
                name: "GitHub宇宙站",
                coords: "X-4040.Y-2020.Z-8080"
            },
            {
                url: "https://google.com",
                name: "Google星际搜索",
                coords: "X-1234.Y-5678.Z-9012"
            },
            {
                url: "https://baidu.com",
                name: "百度星云",
                coords: "X-8888.Y-6666.Z-9999"
            },
            {
                url: "https://bilibili.com",
                name: "哔哩哔哩次元",
                coords: "X-2233.Y-3344.Z-4455"
            }
        ];
        ...
        function getRandomSite() {
            ...
            return randomSites[randomIndex];
        }
        
        function updateSiteDisplay(site) {
            document.getElementById('target-site').textContent = site.name;
            document.getElementById('target-coords').textContent = site.coords;
        }
